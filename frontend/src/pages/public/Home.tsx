      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1 relative z-10">
            <div className="inline-block mb-6 px-6 py-2 bg-blue-500/10 border border-blue-500/30 rounded-full backdrop-blur-md animate-fade-in-up">
              <span className="text-blue-400 text-xs md:text-sm font-bold tracking-wide uppercase">🚀 Automating Infrastructure at Scale</span>
            </div>
              ...
              <div className="relative">
                ...
                {!loading && profile?.badges?.map((badge: any, index: number) => {
                  const getPositionClass = (pos: string) => {
                    switch (pos) {
                      ...
                      case 'bottom-left': return 'bottom-10 -left-4';
                      case 'top-left': return 'top-10 -left-4';
                      case 'bottom-right': return 'bottom-10 -right-4';
                      default: return 'top-10 -right-4';
                    }
                  };
                ...
                {!loading && (!profile?.badges || profile.badges.length === 0) && (
                  <>
                    ...
                    <div className="absolute bottom-10 -left-4 px-4 py-2 bg-white/10 backdrop-blur-xl border border-white/20 text-white rounded-2xl text-xs font-bold shadow-xl animate-float" style={{ animationDelay: '1.5s' }}>
                      <span className="text-blue-400 mr-2">★</span> 5+ Years Exp
                    </div>
                  </>
                )}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Tilt tiltMaxAngleX={5} tiltMaxAngleY={5} scale={1.02} className="h-full">
            ...
            >
              <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity transform group-hover:scale-110 duration-500">
                <svg className="w-32 h-32 text-blue-500" fill="currentColor" viewBox="0 0 24 24"><path d="M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z"/></svg>
              </div>
              <div className="relative z-10">
                <div className="w-14 h-14 bg-blue-500/20 rounded-2xl flex items-center justify-center text-2xl mb-6 group-hover:scale-110 transition-transform duration-300 text-blue-400">💼</div>
                <h4 className="text-xl font-bold text-white mb-3">Experience</h4>
                <p className="text-gray-400 mb-6 leading-relaxed text-sm">Explore my professional journey, roles, and key achievements across different companies.</p>
          ...
          <Tilt tiltMaxAngleX={5} tiltMaxAngleY={5} scale={1.02} className="h-full">
            ...
            >
              <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity transform group-hover:scale-110 duration-500">
                <svg className="w-32 h-32 text-purple-500" fill="currentColor" viewBox="0 0 24 24"><path d="M12 3L1 9l4 2.18v6L12 21l7-3.82v-6l2-1.09V17h2V9L12 3zm6.82 6L12 12.72 5.18 9 12 5.28 18.82 9zM17 15.99l-5 2.73-5-2.73v-3.72l5 2.73 5-2.73v3.72z"/></svg>
              </div>
              <div className="relative z-10">
                <div className="w-14 h-14 bg-purple-500/20 rounded-2xl flex items-center justify-center text-2xl mb-6 group-hover:scale-110 transition-transform duration-300 text-purple-400">🎓</div>
                <h4 className="text-xl font-bold text-white mb-3">Education</h4>
                <p className="text-gray-400 mb-6 leading-relaxed text-sm">Check out my academic background, degrees, and professional certifications.</p>
          ...
          <Tilt tiltMaxAngleX={5} tiltMaxAngleY={5} scale={1.02} className="h-full">
            ...
            >
              <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity transform group-hover:scale-110 duration-500">
                <svg className="w-32 h-32 text-green-500" fill="currentColor" viewBox="0 0 24 24"><path d="M7 2v11h3v9l7-12h-4l4-8z"/></svg>
              </div>
              <div className="relative z-10">
                <div className="w-14 h-14 bg-green-500/20 rounded-2xl flex items-center justify-center text-2xl mb-6 group-hover:scale-110 transition-transform duration-300 text-green-400">⚡</div>
                <h4 className="text-xl font-bold text-white mb-3">Skills</h4>
                <p className="text-gray-400 mb-6 leading-relaxed text-sm">Dive into my technical arsenal, tools, and proficiency levels.</p>
