        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
          {Array(4)
            ...
            .map((_, i) => (
              <div
                key={i}
                className="h-full bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 overflow-hidden flex flex-col"
              >
                {/* Image Skeleton */}
          ...
          {filteredProjects.map((project, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div
                    className={`h-full bg-white/5 backdrop-blur-xl rounded-2xl border transition-all duration-300 group relative overflow-hidden flex flex-col ${
                      project.featured
                          ...
                          {project.images.map((img: string, idx: number) => (
                            ...
                            >
                              ...
                              <div className="absolute inset-0 bg-black/0 group-hover/img:bg-black/40 transition-colors flex items-center justify-center">
                                <svg
                                  className="w-10 h-10 text-white opacity-0 group-hover/img:opacity-100 transform translate-y-4 group-hover/img:translate-y-0 transition-all duration-300"
                                  fill="none"
                                  stroke="currentColor"
                                  viewBox="0 0 24 24"
                                >
