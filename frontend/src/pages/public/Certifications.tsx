...
const SkeletonCard = () => (
  <div className="w-full h-full bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.3)] overflow-hidden flex flex-col md:flex-row relative animate-pulse">
    ...
    <div className="flex-1 p-4 md:p-8 flex flex-col justify-between bg-black/20">
      <div>
        <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-4">
          <div className="h-4 w-12 md:h-5 md:w-16 bg-white/10 rounded-full"></div>
          <div className="h-4 w-16 md:h-5 md:w-20 bg-white/10 rounded-full"></div>
          <div className="h-3 w-20 bg-white/10 rounded ml-auto"></div>
        </div>
        <div className="h-5 md:h-8 w-3/4 bg-white/10 rounded mb-2 md:mb-4"></div>
        <div className="space-y-1.5">
          <div className="h-2.5 md:h-3 w-full bg-white/10 rounded"></div>
          <div className="h-2.5 md:h-3 w-full bg-white/10 rounded"></div>
          <div className="h-2.5 md:h-3 w-2/3 bg-white/10 rounded"></div>
        </div>
      </div>

      <div className="flex gap-3 md:gap-4 mt-4 md:mt-6">
        <div className="h-10 md:h-12 flex-1 bg-white/10 rounded-xl"></div>
        <div className="h-10 md:h-12 w-10 md:w-12 bg-white/10 rounded-xl"></div>
      </div>
    </div>
  </div>
);
  ...
  return (
    ...
    >
      <div className="w-full h-full bg-white/10 backdrop-blur-2xl rounded-2xl md:rounded-3xl border border-white/20 shadow-[0_0_50px_rgba(0,0,0,0.3)] overflow-hidden flex flex-col md:flex-row relative group">
        ...
        {/* Content Section */}
        <div className="flex-1 p-4 md:p-8 flex flex-col justify-between bg-gradient-to-b md:bg-gradient-to-l from-black/40 to-black/60">
          <div>
            <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-4">
              {cert.issuer && (
              ...
              <span className="text-gray-400 text-[10px] md:text-xs font-mono ml-auto">
          ...
          <div className="flex gap-3 mt-3 md:mt-6">
            {cert.credentialUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 py-1.5 md:py-3 bg-white text-black text-[10px] md:text-base font-bold rounded-xl text-center hover:bg-gray-200 transition-colors shadow-lg"
            ...
            {cert.fileUrl && (
              <button
                ...
                className="px-3 py-1.5 md:py-3 bg-white/10 text-white rounded-xl hover:bg-white/20 transition-colors backdrop-blur-md border border-white/10"
                title="View File"
              >
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center py-20 overflow-hidden relative">
        <div className="text-center mb-12 relative z-10">
          ...
          <div className="h-6 w-32 md:h-6 md:w-48 bg-white/10 rounded-lg mx-auto animate-pulse"></div>
        </div>
        <div className="relative w-[85vw] max-w-[800px] h-[460px] md:h-[450px]">
          <SkeletonCard />
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center py-10 md:py-20 overflow-hidden relative">
      ...
      <div className="text-center mb-10 md:mb-12 relative z-10 px-4">
        <h1 className="text-3xl md:text-5xl font-bold mb-3 md:mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500">
          Certifications & Internships
        </h1>
        <p className="text-gray-400 text-sm md:text-lg">Swipe to explore my credentials</p>
      </div>

      <div className="relative w-[88vw] max-w-[800px] h-[460px] md:h-[450px] perspective-1000">
                 ...
                 >
                   {isTop ? (
                     ...
                     // Background card (non-interactive visual)
                      <div className="w-full h-full bg-white/5 backdrop-blur-xl rounded-2xl md:rounded-3xl border border-white/10 shadow-2xl overflow-hidden opacity-50 grayscale flex md:flex-row flex-col">
                          <div className="md:w-2/5 h-40 md:h-full bg-black/20"></div>
                      </div>
                   )}
                 </motion.div>
               );
      ...
      <div className="flex gap-4 mt-8 md:mt-12 relative z-10">
        <button 
          onClick={() => setIndex(prev => prev - 1)}
          className="p-2 md:p-4 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-white transition-all hover:scale-110"
        >
