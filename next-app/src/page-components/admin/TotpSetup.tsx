...
const TotpSetup = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-x-hidden">
      ...
      <div className="relative z-10 w-full max-w-2xl p-8 glass-morphism-strong rounded-3xl border border-white/10 shadow-2xl mx-4">
        ...
        {loading ? (
          ...
          <>
            {/* QR Code */}
            <div className="bg-white p-6 rounded-3xl mb-6 flex justify-center">
              {qrCode ? (
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-4 mb-6">
              ...
              <div className="bg-black/30 rounded-xl p-3 font-mono text-white text-center break-all">
                {secret}
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:border-blue-500 text-center tracking-widest text-2xl"
                  placeholder="000000"
                  maxLength={6}
                />
              </div>
