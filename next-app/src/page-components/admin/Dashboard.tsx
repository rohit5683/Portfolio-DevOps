...
const Dashboard = ({ initialStats }: { initialStats?: any }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      path: "/portal/emergency-contacts",
      count: null,
      ...
      <div className="relative z-10 container mx-auto p-4 md:p-6 pt-16 md:pt-20">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 md:mb-12 gap-4">
          ...
          <div className="flex gap-4">
            <a
              href="/"
              target="_blank"
              className="px-3 py-1.5 md:px-4 md:py-2 text-sm md:text-base bg-white/10 hover:bg-white/20 text-white rounded-xl border border-white/10 transition-all flex items-center gap-2"
            >
            ...
            <button
              onClick={logout}
              className="px-3 py-1.5 md:px-4 md:py-2 text-sm md:text-base bg-red-500/10 hover:bg-red-500/20 text-red-400 rounded-xl border border-red-500/20 transition-all flex items-center gap-2"
            >
              <span>Logout</span>
              <svg
                className="w-4 h-4"
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8 md:mb-12">
          {[
            ...
            <div
              key={idx}
              className="bg-white/5 backdrop-blur-sm p-4 md:p-6 border border-white/10 hover:border-white/20 transition-all rounded-[2rem] md:rounded-[2.5rem] shadow-lg"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {menuItems.map((item, idx) => (
            <div
              ...
              className="group relative bg-white/10 backdrop-blur-md p-5 md:p-6 border border-white/10 hover:border-white/20 hover:bg-white/15 transition-all cursor-pointer overflow-hidden rounded-[2rem] md:rounded-[2.5rem] shadow-lg"
            >
              <div
              ...
              <div className="relative z-10">
                <div
                  className={`w-10 h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-br ${item.color} flex items-center justify-center text-white mb-4 shadow-lg group-hover:scale-110 transition-transform`}
                >
                  {item.icon}
                </div>
