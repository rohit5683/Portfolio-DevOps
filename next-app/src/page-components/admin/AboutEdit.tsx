    ...
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <div className="relative z-10 container mx-auto px-3 py-6 md:px-4 md:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                  ...
                  <div className="space-y-3 md:space-y-4">
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        className="w-full p-2 md:p-2.5 rounded-xl bg-black/40 border border-white/10 text-white text-xs md:text-sm focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/20 outline-none transition-all"
                      >
                  ...
                  <div className="space-y-3 md:space-y-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full p-2 md:p-2.5 rounded-xl bg-black/40 border border-white/10 text-white text-xs md:text-sm focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/20 outline-none transition-all font-medium"
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        className="w-full p-2 md:p-2.5 rounded-xl bg-black/40 border border-white/10 text-white text-xs md:text-sm focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/20 outline-none transition-all h-20 resize-none"
          ...
          <div className="bg-white/10 backdrop-blur-md p-4 md:p-6 rounded-3xl border border-white/20 shadow-xl lg:col-span-2">
            <h2 className="text-lg md:text-xl font-bold text-white mb-4 md:mb-6 flex items-center gap-2 border-b border-white/5 pb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
              {profile.highlights?.map((highlight: any, index: number) => (
                <div
                  key={index}
                  className="bg-black/40 p-4 md:p-5 border border-white/10 relative group/item transition-all hover:border-blue-500/30 rounded-2xl"
                >
                  <button
                    onClick={() => {
                  ...
                  <div className="flex gap-3 md:gap-4">
                    <div className="space-y-1.5 flex-shrink-0">
                      ...
                      <input
                        ...
                        className="w-12 h-12 md:w-14 md:h-14 p-2 md:p-2.5 rounded-xl bg-black/40 border border-white/10 text-white text-center text-xl md:text-2xl outline-none focus:border-blue-500/50"
                        placeholder="🏆"
                      />
                    </div>
                    <div className="flex-1 space-y-2 md:space-y-3">
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full p-2 md:p-2.5 rounded-xl bg-black/40 border border-white/10 text-white text-xs md:text-sm outline-none focus:border-blue-500/50"
            ...
            <div className="flex gap-3 md:gap-4">
              <button
                ...
                className="flex-1 bg-white/5 hover:bg-white/10 text-white font-bold py-2.5 md:py-3 px-3 md:px-4 rounded-xl transition-all border border-white/10 flex items-center justify-center gap-2 text-sm"
              >
              ...
              <button
                ...
                className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 md:py-3 px-3 md:px-4 rounded-xl transition-all shadow-lg hover:shadow-blue-500/20 flex items-center justify-center gap-2 text-sm"
              >
                Save Highlights
              </button>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-md p-4 md:p-6 rounded-3xl border border-white/20 shadow-xl lg:col-span-2">
            <h2 className="text-lg md:text-xl font-bold text-white mb-4 md:mb-6 flex items-center gap-2 border-b border-white/5 pb-3">
              ...
              Statistics (Shared with Home & About Pages)
            </h2>
            ...
            {(() => {
              ...
              const currentStatsList = (profile?.stats && profile.stats.length > 0)
                ? profile.stats
                : ((profile?.animatedStats && profile.animatedStats.length > 0) ? profile.animatedStats : defaultStats);
                ...
                <>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
                    <div className="md:col-span-2 flex items-start gap-2.5 p-3 bg-blue-500/10 border border-blue-500/20 rounded-xl text-xs text-blue-300">
                      ...
                      <span>Stats with labels containing <strong>"year"</strong> or <strong>"experience"</strong> are auto-calculated from your Experience database on the website.</span>
                    </div>
                    {currentStatsList.map((stat: any, index: number) => {
                      ...
                      return (
                        ...
                        >
                          <button
                            onClick={() => {
                              const newStats = [...currentStatsList];
                          ...
                          <div className="grid grid-cols-4 gap-3 md:gap-4">
                            <div className="space-y-1.5">
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  const newStats = [...currentStatsList];
                                  newStats[realIndex] = { ...newStats[realIndex], icon: e.target.value };
                                  setProfile({ ...profile, stats: newStats, animatedStats: newStats });
                                }}
                            ...
                            <div className="col-span-2 space-y-1.5">
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  const newStats = [...currentStatsList];
                                  newStats[realIndex] = { ...newStats[realIndex], label: e.target.value };
                                  setProfile({ ...profile, stats: newStats, animatedStats: newStats });
                                }}
                            ...
                            <div className="space-y-1.5">
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  const newStats = [...currentStatsList];
                                  newStats[realIndex] = { ...newStats[realIndex], value: e.target.value };
                                  setProfile({ ...profile, stats: newStats, animatedStats: newStats });
                                }}
